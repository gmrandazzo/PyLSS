...
class Ui_ComputeLSS(object):
    def setupUi(self, ComputeLSS):
        ...
        self.label_5 = QtGui.QLabel(ComputeLSS)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.verticalLayout.addWidget(self.label_5)
        self.gradientModeBox = QtGui.QComboBox(ComputeLSS)
        self.gradientModeBox.setObjectName(_fromUtf8("gradientModeBox"))
        self.gradientModeBox.addItem(_fromUtf8(""))
        self.gradientModeBox.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, ComputeLSS):
        ...
        self.label_5.setText(_translate("ComputeLSS", "Gradient mode type", None))
        self.gradientModeBox.setItemText(0, _translate("ComputeLSS", "Linear time gradient", None))
        self.gradientModeBox.setItemText(1, _translate("ComputeLSS", "Logarithmic time gradient", None))
