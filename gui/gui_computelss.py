# Form implementation generated from reading ui file 'gui/computelss.ui'
#
...
class Ui_ComputeLSS(object):
    def setupUi(self, ComputeLSS):
        ...
        self.label_4 = QtWidgets.QLabel(parent=ComputeLSS)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout.addWidget(self.label_4)
        self.dataBox = QtWidgets.QComboBox(parent=ComputeLSS)
        self.dataBox.setObjectName("dataBox")
        self.horizontalLayout.addWidget(self.dataBox)
        self.gridLayout.addLayout(self.horizontalLayout, 0, 0, 1, 3)
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_5 = QtWidgets.QLabel(parent=ComputeLSS)
        self.label_5.setObjectName("label_5")
        self.verticalLayout.addWidget(self.label_5)
        self.gradientModeBox = QtWidgets.QComboBox(parent=ComputeLSS)
        ...
        self.lineEdit = QtWidgets.QLineEdit(parent=ComputeLSS)
        self.lineEdit.setObjectName("lineEdit")
        self.gridLayout_2.addWidget(self.lineEdit, 0, 1, 1, 1)
        self.label_7 = QtWidgets.QLabel(parent=ComputeLSS)
        ...
        self.closeButton = QtWidgets.QPushButton(parent=ComputeLSS)
        self.closeButton.setMaximumSize(QtCore.QSize(110, 32))
        self.closeButton.setObjectName("closeButton")
        self.gridLayout.addWidget(self.closeButton, 3, 1, 1, 1)
        self.okButton = QtWidgets.QPushButton(parent=ComputeLSS)
