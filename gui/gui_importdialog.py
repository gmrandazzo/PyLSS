...
class Ui_ImportDialog(object):
    def setupUi(self, ImportDialog):
        ...
        self.dwelVolSpinBox.setProperty("value", 0.37)
        ...
        self.t0SpinBox.setProperty("value", 0.969)
        ...
        self.flowrateSpinBox.setProperty("value", 0.3)
        self.flowrateSpinBox.setObjectName(_fromUtf8("flowrateSpinBox"))
        self.gridLayout.addWidget(self.flowrateSpinBox, 2, 1, 1, 1)
        self.label_5 = QtGui.QLabel(ImportDialog)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.gridLayout.addWidget(self.label_5, 3, 0, 1, 1)
        self.GStartSpinBox = QtGui.QDoubleSpinBox(ImportDialog)
        self.GStartSpinBox.setProperty("value", 5.0)
        self.GStartSpinBox.setObjectName(_fromUtf8("GStartSpinBox"))
        self.gridLayout.addWidget(self.GStartSpinBox, 3, 1, 1, 1)
        self.label_6 = QtGui.QLabel(ImportDialog)
        self.label_6.setObjectName(_fromUtf8("label_6"))
        self.gridLayout.addWidget(self.label_6, 4, 0, 1, 1)
        self.GStopSpinBox = QtGui.QDoubleSpinBox(ImportDialog)
        self.GStopSpinBox.setProperty("value", 95.0)
        self.GStopSpinBox.setObjectName(_fromUtf8("GStopSpinBox"))
        self.gridLayout.addWidget(self.GStopSpinBox, 4, 1, 1, 1)
    ...
    def retranslateUi(self, ImportDialog):
        ...
        self.label_5.setText(_translate("ImportDialog", "Gradient Start", None))
        self.label_6.setText(_translate("ImportDialog", "Gradient Start", None))
